...
pub struct Config {
  ...
  pub stripe_connect_webhook_key: String,
  pub stripe_account_webhook_key: String,
  ...
  pub fn new() -> Result<Self, env::VarError> {
    Result::Ok(
      Self {
        ...
        stripe_connect_webhook_key: env::var("STRIPE_CONNECT_WEBHOOK_SECRET").unwrap(),
        stripe_account_webhook_key: env::var("STRIPE_ACCOUNT_WEBHOOK_SECRET").unwrap(),
